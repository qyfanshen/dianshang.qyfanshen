# Cross-Border E-Commerce Console
...
<p align="center">
  ...
  <a href="https://github.com/qyfanshen/dianshang.qyfanshen/actions"><img src="https://img.shields.io/github/actions/workflow/status/qyfanshen/dianshang.qyfanshen/ci.yml?branch=master&label=CI" alt="CI"></a>
  <a href="https://img.shields.io/github/languages/code-size/qyfanshen/dianshang.qyfanshen"><img src="https://img.shields.io/github/languages/code-size/qyfanshen/dianshang.qyfanshen" alt="Code size"></a>
  <a href="https://github.com/qyfanshen/dianshang.qyfanshen/issues"><img src="https://img.shields.io/github/issues/qyfanshen/dianshang.qyfanshen" alt="Issues"></a>
  <a href="https://github.com/qyfanshen/dianshang.qyfanshen/stargazers"><img src="https://img.shields.io/github/stars/qyfanshen/dianshang.qyfanshen?style=social" alt="Stars"></a>
</p>
...
- **📦 Orders & fulfillment** — Track orders, shipments and in-transit parcels across channels in real time.
- **🌍 Global market operations** — Manage products, inventory and pricing across international markets.
- **📈 Profit analytics** — Monitor sales, margins and fulfillment KPIs to steer the business.

## Features

### Core Features
- Built for cross-border sellers: multi-platform SKU & order flow
- Profit analytics-friendly landing layout
...
```bash
git clone https://gitee.com/qyfanshen/dianshang.qyfanshen.git
cd dianshang.qyfanshen.com
...
server {
    listen 80;
    server_name dianshang.qyfanshen.com;
...
server {
    ...
    ssl_certificate     /etc/nginx/ssl/ecommerce-console.crt;
    ssl_certificate_key /etc/nginx/ssl/ecommerce-console.key;

    root /var/www/dianshang.qyfanshen.com;
...
- [ ] HTTPS 已生效（浏览器锁图标）
- [ ] `https://dianshang.qyfanshen.com/.env` 返回 404
...
- Domain: https://dianshang.qyfanshen.com
